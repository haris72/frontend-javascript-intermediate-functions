...
for (let i = 0; i < grades.length; i++) {
    gemid = gemid + grades[i];
}

console.log(gemid / grades.length);
...
console.log((Math.round((gemiddeld(grades) + Number.EPSILON) * 100) / 100));
